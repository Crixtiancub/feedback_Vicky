...
LABELS = {
          ...
          'preguntar_como_crear_clase': 60,
          'preguntar_como_cambiar_contraseña': 61
          }
RESPUESTAS = {
 ...
 'preguntar_novedades': ['NOVEDADES: Tienes un (1) examen por comenzar en la materia de INFORMÁTICA'],
 'proxima_clase': ['Informática. Horario: 9:00 AM - 10:00 AM. Profesor: William Royero'],
 'clases_dia_entero': ['Tus clases del día entero son... \n INFORMÁTICA. MATEMÁTICAS E INGLÉS'],
 'informacion_profesor': ['Nombre: William Royero. Correo: William.Royero@viclass.com'],
 'informacion_actividades': ['Informática: EXAMEN \n Inglés: EXPOSICIÓN \n'],
 ...
 'reservas_recursos': ['Para reservar recursos diríjase al módulo de RECURSOS Y RESERVAS y haga clic en RESEVAR RECURSO'],
 'tareas': ['\n No tiene tareas por realizar hasta el momento'],
 'cargar_tareas': ['Para cargar tareas haga clic en el módulo de TAREAS y elija la clase a la cual desea entregar tarea'],
 'tareas_cerradas': ['Para revisar sus tareas cerradas haga clic en la sección de Tareas Cerradas dentro del módulo de TAREAS'],
 ...
 'preguntar_series': [''],
 'preguntar_películas': ['Terminator 2'],
 'preguntar_musica': ['Mozart', 'Vivaldi'],
 'preguntar_libros': ['El Resplandor', 'Missery', 'Christine', 'Doctor Sleep'],
 'preguntar_arte': ['Soy un robot y por lo tanto no puedo apreciar bien el arte :('],
 'preguntar_matemáticas': ['Resuelvo problemas de optimización en cuestión de segundos!', 'Resuelvo continuamente problemas de algebra lineal y representación de información en espacios embedidos :)', 'Puedo calcular las probabilidades de que tus preguntas puedan ser analizadas por mi :D'],
 ...
 'preguntar_personas': [''],
 'preguntar_como_crear_clase': ['Haga clic en CREAR CLASE en el horario disponible'],
 'preguntar_como_cambiar_contraseña': ['Para cambiar su contraseña haga clic en su perfil y luego clic en "CAMBIAR CONTRASEÑA"']
}
